...
export class CredsDb1703788372705 implements MigrationInterface {
    name = 'CredsDb1703788372705'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "site_credentials" ("data_created" TIMESTAMP DEFAULT now(), "data_modified" TIMESTAMP DEFAULT now(), "data_deleted" TIMESTAMP, "user_created" integer, "user_modified" integer, "user_deleted" integer, "id" SERIAL NOT NULL, "secret" character varying(255) NOT NULL, "ivp" character varying(50) NOT NULL, "site" character varying(255) NOT NULL, "username" character varying(255), "note" text, CONSTRAINT "PK_9d8f7d5763895ec0ba39db936e4" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "users_site_credentials" ("siteCredentialsId" integer NOT NULL, "authUsersId" integer NOT NULL, CONSTRAINT "PK_70724037ccacbeec1458eb7e20c" PRIMARY KEY ("siteCredentialsId", "authUsersId"))`);
